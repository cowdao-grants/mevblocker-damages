...
1. Rename this file config.py
2. Get your infuria key (https://docs.infura.io/dashboard/create-api) and copy paste it bellow
...
5. Insert your relative csv path

"""

infura_api_key = 'INSERT-YOUR-INFURIA-API-KEY'
eth_scan_api_key = 'INSERT-YOUR-ETHERSCAN-API-KEY'
tenderly_access_token = 'INSERT-YOUR-TENDERLY-ACCESS-TOKEN'
csv_file_path = 'INSERT YOUR CSV PATH' #example: 'incident1.csv'
