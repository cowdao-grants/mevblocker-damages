...
2. Get your infuria key (https://docs.infura.io/dashboard/create-api) and copy paste it bellow. Make sure you have activated the Ethereum Mainnet endpoint
...
infuria_url = f"https://mainnet.infura.io/v3/{infura_api_key}"
